...
{   
   ...
   */
    ...
    private Collection $entitiesB; // in questo "array" sono memorizzate tutti i riferimenti agli oggetti di classe Entity2
    ...
    public function addEntityB(EntityB $entityB): self {
      ...
      if (!$this->entitiesB->contains($entityB)) {
        $this->entitiesB->add($entityB); // aggiungi l'entità
